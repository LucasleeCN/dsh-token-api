...
#dsh-client-ui-token-billing-fab {
  ...
  border-radius: 12px;
  background:
    linear-gradient(180deg, color-mix(in srgb, #4d6bfe 5%, transparent), transparent 40%),
...
#dsh-client-ui-token-billing-fab:hover {
  background:
    linear-gradient(180deg, color-mix(in srgb, #4d6bfe 7%, transparent), transparent 40%),
...
.dsh-tb-fab-reasoning input[type="range"]::-webkit-slider-thumb:hover {
  box-shadow: 0 2px 8px rgba(77, 107, 254, 0.45);
}
.dsh-tb-fab-reasoning input[type="range"]::-webkit-slider-thumb:active {
  cursor: grabbing;
  transform: scale(1.1);
  animation: none;
  box-shadow: 0 2px 10px rgba(77, 107, 254, 0.55);
}
@keyframes dsh-tb-thumb-breathe {
  0%, 100% {
    box-shadow: 0 1px 5px rgba(15, 23, 42, 0.3), 0 0 0 0 rgba(77, 107, 254, 0.35);
  }
  50% {
    box-shadow: 0 2px 8px rgba(77, 107, 254, 0.4), 0 0 0 5px rgba(77, 107, 254, 0);
  }
}
