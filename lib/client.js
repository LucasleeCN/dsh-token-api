...
#dsh-client-ui-token-billing-fab {
  ...
  border-radius: 12px;
  background:
    linear-gradient(180deg, color-mix(in srgb, #4d6bfe 4%, transparent), transparent 38%),
...
#dsh-client-ui-token-billing-fab:hover {
  background:
    linear-gradient(180deg, color-mix(in srgb, #4d6bfe 6%, transparent), transparent 38%),
