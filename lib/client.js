...
`
    ...
    function clampPosition(root, position) {
      ...
      var fabWidth = fab ? fab.offsetWidth || 80 : 80
      var fabHeight = fab ? fab.offsetHeight || 32 : 32
      var margin = 8
...
<div id="dsh-client-ui-token-billing-panel" class="dsh-tb-hidden">
  ...
  <div class="dsh-tb-body">
    ...
    <div class="dsh-tb-reasoning" id="dsh-tb-reasoning-block">
      <input id="dsh-tb-reasoning-range" type="range" min="0" max="0" step="1" value="0" aria-label="推理强度">
