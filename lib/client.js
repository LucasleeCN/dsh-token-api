...
#dsh-client-ui-token-billing-fab {
  ...
  border-radius: 12px;
  background:
    linear-gradient(180deg, color-mix(in srgb, var(--dsh-tb-accent, #4d6bfe) 8%, transparent), transparent 46%),
...
#dsh-client-ui-token-billing-fab:hover {
  background:
    linear-gradient(180deg, color-mix(in srgb, var(--dsh-tb-accent, #4d6bfe) 12%, transparent), transparent 48%),
